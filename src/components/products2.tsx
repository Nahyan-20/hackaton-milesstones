...
const Seller = () => {
  ...
  return (
    <div className="w-full min-h-screen space-x-3 space-y-4 bg-[#F6F7F9] pb-4">
      <h1 className="w-full h-[44px] pr-3 pl-12 pt-6 gap-8 text-xl md:text-2xl text-[#90A3BF]">
      Recomendation Car
      </h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 px-3 mx-auto sm:px-8 pt-10 justify-center items-center max-w-full">
            ...
            >
              ...
              <div className="-space-y-3">
                ...
                <div className="-space-y-7">
                  ...
                  <div className="pb-4 flex justify-end sm:translate-x-5">
