...
const Products = () => {
  ...
  return (
    <div className="w-full  sm:h-[500px] space-x-3 space-y-4 bg-[#F6F7F9] pb-9 sm:pb-0">
      <h1 className="w-full h-[44px] pr-3 pl-12 pt-6 gap-8 text-xl md:text-2xl text-[#90A3BF]">
        Popular Cars
      </h1>
      <div className="flex sm:grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 px-3 mx-auto sm:px-8 pt-10 justify-start items-center overflow-x-auto sm:overflow-visible space-x-4 sm:space-x-0 w-full scrollbar-hide">

        {product.map((data, index) => {
          return (
            <div
              key={data.id}
              className="bg-white rounded-[10px] pl-4 pt-6 -space-y-2 w-full"
            >
              ...
              <div className="-space-y-3">
                <div className="w-[230px] h-[170px] pt-6 flex justify-start sm:justify-center">
                  <Image src={data.img_url} alt={data.title} width={200} height={19} />
                </div>
                <div className="-space-y-7">
                  <div className="   flex justify-evenly pl-2 items-center gap-2 text-[#90A3BF] w-[256px] h-[80px] texl-base pb-12 translate-y-6">
                  ...
                  <div className="pb-4 flex justify-end sm:translate-x-7">
                    <button className="text-white bg-[#3563E9] px-5 py-3 rounded-[10px] mr-6">
                      Rent Now
                    </button>
                  </div>
