...
const Fool = () => {
  ...
  return (
    <div className=" min-h-screen space-x-3 space-y-4 bg-slate-200 pb-4 ">
     
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6 mx-auto sm:px-8 pt-10 justify-center items-center ">
            ...
            >
              ...
              <div className="-space-y-3">
                ...
                <div className="-space-y-5">
                  <div className="   flex justify-evenly pl-2 items-center  text-[#90A3BF] w-[256px] h-[80px] texl-base pb-12 translate-y-6 sm:-translate-x-2">
